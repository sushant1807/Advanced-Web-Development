...
<body>
	...
	<div id="page-wrap">
		...
		<h1>Quiz answers of students</h1>
            ...
            <ol>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-1-answers-B">B) Personal Home Page</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" />
                        <label for="question-1-answers-C">C) Primary Home Page</label>
                    </div>
